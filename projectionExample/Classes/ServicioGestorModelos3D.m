...
-(id)init
{
    if(self)
    {
        ...
        [tower01 setIcono:[UIImage imageNamed:@"bg-addbutton.png"]];
        [tower01 setNavegacionPorNodo:[NSMutableDictionary new]];
        [[tower01 navegacionPorNodo] setObject:@"Towe01_FloorView" forKey:@"CHOC_L_06-submesh1"];
        
        Modelo3D* towe01_FloorView = [[Modelo3D new] autorelease];
        [towe01_FloorView setNombre:@"Towe01_FloorView"];
        [towe01_FloorView setIcono:[UIImage imageNamed:@"bg-addbutton.png"]];
        ...
        [tower01FloorPlanView setIcono:[UIImage imageNamed:@"bg-addbutton.png"]];
